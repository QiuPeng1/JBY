...
#define MAX_FLASH_SIZE  0xF0000

#define NEED_UPGRADE_FLAG 0x1127

#define ONE_LINE_H 30
u8 dispIndex = 0;

#define BUF_LEN 64*1024
u8 readBuffer[BUF_LEN];
...
u32 upgradeFileSize = 0;
u32 currentReadLen = 0;
u32 readLen = 0;

u32 currentWriteLen = 0;
...
enum
{
	...
	STATE_FORWARD_COVER_LENGTH = 0x02,
	STATE_COMPUTE = 0x04,
	STATE_FORWARD_NOTE_LEAVE = 0x08,
	STATE_BACKWARD_COVER_LENGTH = 0x10,
	STATE_BACKWARD_COVER_ENTERANCE = 0x20,
	STATE_BACKWARD_NOTE_LEAVE = 0x40,
};
u16 noteState = 0;

#define MP_FROM_ENTERANCE_TO_LENGTH 500//200//150 //55mm 91mp
u8 g_maxMpFromEnteranceToLength = 0;
#define MP_FROM_LENGTH_TO_ENTERANCE 70//200//150 //55mm 91mp
u8 g_maxMpFromLengthToEnterance = 0;

#define MP_FROM_LENGTH_TO_LEAVE 150//120 //50mm 82MP
u8 g_maxMpFromLengthToLeave = 0;

#define MP_FROM_COMPUTE_TO_LENGTH 120 
u8 g_maxMpFromComputeToLength = 0;
...
#define g_currency INDEX_USD //savedPara.userWorkPara.d[INDEX_MONEY_TYPE]
