...
typedef enum {
  ENUM_IDLE = 0,
  ENUM_GET_FULL_DEV_DESC,  			//Éè±¸ÃèÊö
  ENUM_SET_ADDR,					//Éè±¸µØÖ·
  ENUM_GET_CFG_DESC,				//ÅäÖÃÃèÊö·û
  ENUM_GET_FULL_CFG_DESC,			//È«ËÙ¿ØÖÆÃèÊö·û
  ENUM_GET_MFC_STRING_DESC,			//×Ö·û´®ÃèÊö·û
  ENUM_GET_PRODUCT_STRING_DESC,		//²úÆ·ÃèÊö
  ENUM_GET_SERIALNUM_STRING_DESC,	//×Ö·û´®µÄÃèÊö·û
  ENUM_SET_CONFIGURATION,			//ÉèÖÃÅäÖÃ
  ENUM_DEV_CONFIGURED				//Éè±¸ÅäÖÃ
} ENUM_State;  
...
typedef struct _Host_TypeDef
{
  ...
  USBH_Class_cb_TypeDef               *class_cb;  //call_back »Øµ÷
