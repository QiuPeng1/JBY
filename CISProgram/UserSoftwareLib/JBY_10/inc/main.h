...
const u32 NationFlagBMP[][2] = {//国旗图标，金额明细
	...
	{0,0}/*保加利*/,		                      {BMP_GNMAD,BMP_GOMAD}/*摩洛哥*/,		      {0,0}/*利比亚*/,					              	{0,0}/*****币*/,
	{0,0}/*南非币*/,		                      {0,0}/*肯尼亚*/,		                      {BMP_BFLAGARS,BMP_BLISTARS}/*阿根廷*/, 	{BMP_BFLAGTHB,BMP_BLISTTHB}/*泰珠币*/,
	{0,0}/*埃及币*/,		                      {0,0}/*斯里兰*/,		                      {0,0}/*印尼币*/,		                      {0,0}/*以色列*/, 
	{0,0}/*阿富汗*/,		                      {0,0}/*约旦币*/,		                      {BMP_BFLAGIQD,BMP_BLISTIQD}/*伊拉克*/,   {0,0}/*黎巴嫩*/,  
	{BMP_CBFLAGSAR,BMP_CBLISTSAR}/*沙特*/,	{BMP_CBFLAGAED,BMP_CBLISTAED}/*阿联酋*/,	{BMP_GLBYR,BMP_GMBYR}/*白俄*/,           {BMP_GHUZS,BMP_GIUZS}/*乌兹别克斯坦*/,  
};
...
u16 const BYR_NOTE_VALUE[] = {500,200,100,50,20,10,5,0,0,0};
