...
FIFO_EXT UART_CMD gb_packageFromUart1;
...
#define UARTPAC_IN_FIFO_SIZE 	10
...
FIFO_EXT UART_CMD uart1Pacinfifo_data[UARTPAC_IN_FIFO_SIZE];
#define uart1Pacinfifo_count (uart1Pacinfifo_GetCount())
FIFO_EXT u16 uart1Pacinfifo_front;
FIFO_EXT u16 uart1Pacinfifo_rear;
FIFO_EXT void uart1Pacinfifo_Clear(void);
FIFO_EXT void uart1Pacinfifo_DataIn(UART_CMD d);
FIFO_EXT UART_CMD uart1Pacinfifo_DataOut(void);
FIFO_EXT u16 uart1Pacinfifo_GetSpace(void);
FIFO_EXT u16 uart1Pacinfifo_GetCount(void);
